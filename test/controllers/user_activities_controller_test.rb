...
class UserActivitiesControllerTest < ActionController::TestCase
  ...
  test "should create user_activity" do
    assert_difference('UserActivity.count') do
      post :create, user_activity: { activity_id: @user_activity.activity_id, attending: @user_activity.attending, user_id: @user_activity.user_id }
    end
  ...
  test "should update user_activity" do
    patch :update, id: @user_activity, user_activity: { activity_id: @user_activity.activity_id, attending: @user_activity.attending, user_id: @user_activity.user_id }
    assert_redirected_to user_activity_path(assigns(:user_activity))
  end
